...
public class BroadcastMessage implements Serializable{
    ...
    public enum MessageTypes {
        ...
        INVITATION_TO_WORKSPACE, REQUEST_FILE, REQUEST_WORKSPACE, FILE_OPEN, FILE_CLOSE, I_AM_USER, WORKSPACE_TIMESTAMP, WORKSPACE_UPDATED, OWNERS_VERSION, WORKSPACE_PRIVILEGES_CHANGED
    }
}